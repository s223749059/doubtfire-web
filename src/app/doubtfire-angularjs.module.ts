...
import { ProgressModalService } from './common/modals/progress-modal/progress-modal.service';
...
DoubtfireAngularJSModule.factory('ProgressModal', downgradeInjectable(ProgressModalService));
